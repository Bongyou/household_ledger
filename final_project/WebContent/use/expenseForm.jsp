...
<body>
	...
	<div style = "margin-top : 40px;" id="sear">
		...
		<div>
			<div>	
				<div style = "margin-top : 20px; margin-left : 350px;">
					<form action="useProcExpense.jsp" method="post" name="form" >
						<h3>시작</h3>
						...
						<h3>일</h3>
						<br><br>
						<input type ="submit" value = "검색" onclick = "check()" style="margin-left:165px;">
							<br><br><br>
					</form>
				</div>
					<form action = "useProcExpense2.jsp" method = "POST" style = "position : absolute; left: 840px; top : 140px;">
						<select id = "size3" name = "sort" style= "margin-left : 110px;">
							<option>식비</option>
							<option>교통비</option>
							<option>간식</option>
							<option>생활비</option>
