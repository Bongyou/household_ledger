...
<div class="row">
    <div class="col-sm-4" id = "pos1">
      <p class="text-center" id = "st"><strong>수입 입력</strong></p><br>
      <a href="#demo" data-toggle="collapse">
      <div id = "pos3"><button id = "button1">수입</button></div>
      </a>
      <div id="demo" class="collapse">
      		<form id = "p" method = "POST" action = "insertImportProc.jsp">
			날짜 
			...
			금액: <input type = "text" id = "size3" name = "money">
